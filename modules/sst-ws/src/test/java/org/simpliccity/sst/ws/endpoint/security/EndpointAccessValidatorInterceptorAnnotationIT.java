...
@ContextConfiguration(classes=EndpointAccessValidatorInterceptorAnnotationConfig.class)
@ActiveProfiles("wsAccess")
public class EndpointAccessValidatorInterceptorAnnotationIT 
{
