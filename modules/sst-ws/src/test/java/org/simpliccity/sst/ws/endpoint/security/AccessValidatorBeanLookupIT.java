...
@ContextConfiguration({ "/AccessValidatorBeanLookupIT.xml" })
public class AccessValidatorBeanLookupIT
{
	@Autowired
	...
	public void testNameGeneration()
	{
		...
		container.setValue("TestValidator");
		
		// Lookup the bean using the specified metadata
		Object validator = lookupManager.lookupBeanByMetadata(container);
