...
@KeySource(HS512TestKeyProvider.ALGORITHM)
public class HS512TestKeyProvider extends AbstractEncodedMapKeyProvider 
{
	public static final String ALGORITHM = "HS512";
	
	public static final String JCA_ALGORITHM = "HmacSHA512";
	
	public HS512TestKeyProvider()
	{
		Map<String, String> keyMap = new HashMap<String, String>();
		keyMap.put("SST", "1234567890");
		keyMap.put("ALT", "0987654321");
