...
package org.simpliccity.sst.web.security.config;
...
public class ServiceAccessControlHandlerInterceptorBeanDefinitionParser	extends AbstractServiceAccessControlBeanDefinitionParser
{
	@SuppressWarnings("rawtypes")
	@Override
	protected Class getEnforcementClass() 
	{
		return ServiceAccessControlHandlerInterceptor.class;
	}
}
