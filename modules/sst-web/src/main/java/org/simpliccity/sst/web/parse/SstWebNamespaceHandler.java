...
package org.simpliccity.sst.web.parse;

import org.simpliccity.sst.web.security.config.ServiceAccessControlHandlerInterceptorBeanDefinitionParser;
 ...
 *
 */
public class SstWebNamespaceHandler extends NamespaceHandlerSupport 
{
	@Override
	public void init() 
	{
		registerBeanDefinitionParser("access", new ServiceAccessControlHandlerInterceptorBeanDefinitionParser());
	}
}
