...
@ContextConfiguration(classes={JwtTokenClientHttpRequestInterceptorConfig.class})
@ActiveProfiles("jwtClientInterceptor")
public class JwtTokenClientHttpRequestInterceptorIT 
{
	@Autowired
