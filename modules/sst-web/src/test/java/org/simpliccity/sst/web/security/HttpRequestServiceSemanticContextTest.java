...
public class HttpRequestServiceSemanticContextTest 
{
	...
	private HttpRequestServiceSemanticContext context = new HttpRequestServiceSemanticContext(request);
	...
	{
		assertEquals("Get payload.", request.getInputStream(), context.getPayload());
	}
