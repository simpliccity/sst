...
@WebAppConfiguration
@ContextConfiguration(classes=JwtTokenAuthenticationProviderAnnotationConfig.class)
@ActiveProfiles("jwtToken")
public class JwtTokenAuthenticationProviderAnnotationIT 
{
	@Autowired
