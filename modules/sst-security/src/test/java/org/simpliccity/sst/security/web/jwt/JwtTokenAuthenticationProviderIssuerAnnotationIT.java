...
@WebAppConfiguration
@ContextConfiguration(classes=JwtTokenAuthenticationProviderIssuerAnnotationConfig.class)
@ActiveProfiles("jwtTokenIssuer")
public class JwtTokenAuthenticationProviderIssuerAnnotationIT 
{
	@Autowired
	...
	@Resource(name="sstJwtTokenGenerator")
	private UserJwtTokenGenerator jwt;

	@Resource(name="altJwtTokenGenerator")
	private UserJwtTokenGenerator altJwt;

	@Resource(name="unknownJwtTokenGenerator")
	private UserJwtTokenGenerator unknownJwt;
	...
	{
		String jwtToken = generateJwtToken(jwt, "user1", "USER");
	...
	@Test
	public void testAltTokenAuthenticationAccessAllowed() throws Exception
	{
		String jwtToken = generateJwtToken(altJwt, "user1", "USER");
	...
	{
		String jwtToken = generateJwtToken(jwt, "user2", "OTHER");
	...
	@Test
	public void testUnknownIssuerAccessDenied() throws Exception
	{
		String jwtToken = generateJwtToken(unknownJwt, "user1", "OTHER");
	...
	private String generateJwtToken(UserJwtTokenGenerator generator, String subject, String... roles)
	{
		...
		return generator.generateJwtToken(principal);
	}
}
