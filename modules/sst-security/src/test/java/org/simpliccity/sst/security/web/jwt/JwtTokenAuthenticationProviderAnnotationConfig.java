...
@Profile("jwtToken")
@EnableSstJwtTokenAuth(knownIssuers=@IssuerKey(issuer="SST", keyAlias="SST"))
public class JwtTokenAuthenticationProviderAnnotationConfig extends JwtTokenAuthenticationProviderAnnotationConfigSupport
{
	@Bean
