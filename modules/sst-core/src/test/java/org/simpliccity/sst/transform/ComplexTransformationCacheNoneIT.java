...
@ContextConfiguration({ "/ComplexTransformationCacheNoneIT.xml" })
public class ComplexTransformationCacheNoneIT 
{
	@Autowired
	...
	{
		Assert.assertEquals(TransformationCacheMode.NONE, transformer.getCacheManager().getDefaultCacheModeEnum());
	}
	
	@Test
	public void testNonCachedIdenticalValue()
	{
