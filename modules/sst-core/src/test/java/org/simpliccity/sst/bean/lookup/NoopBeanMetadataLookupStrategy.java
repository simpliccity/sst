...
public class NoopBeanMetadataLookupStrategy implements BeanMetadataLookupStrategy 
{
	...
	{
		logger.debug("Performed noop annotated lookup.");
		return null;
	}
	...
	{
		logger.debug("Performed noop typed lookup.");
		return null;
	}
}
