...
public class BeanMetadataLookupExceptionTest 
{
	...
	{
		Exception e = new BeanMetadataLookupException();
	...
	{
		Exception e = new BeanMetadataLookupException(TEST_MESSAGE);
	...
	public void testCauseOnlyConstructor()
	{
		...
		Exception e = new BeanMetadataLookupException(cause);
	...
	{
		Exception cause = new Exception();
		Exception e = new BeanMetadataLookupException(TEST_MESSAGE, cause);
