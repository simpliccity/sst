...
@Configuration
@IfEnabled(EnableSstTransformer.class)
@EnableSstBeanLookup
public class DelegatingTransformerConfiguration extends	TransformerConfigurationSupport
{
	@Autowired(required=false)
	private TransformerConfigurer configurer;
	...
	protected void configureTransformer(Transformer transformer)
	{
		if (configurer != null)
		{
			configurer.configureTransformer(transformer);
		}
	}
	...
	protected void configureCacheManager(TransformationCacheManager manager)
	{
		if (configurer != null)
		{
			configurer.configureCacheManager(manager);
		}
	}
}
