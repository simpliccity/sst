 ...
 *
 */
public class ServiceAccessValidatorAnnotationBeanNameGenerator extends AbstractLookupAnnotationNamespaceBeanNameGenerator
{
	/**
	 * Namespace name pattern ({@value}).
	 */
	public static final String NAME_PATTERN = "sst.serviceAccessValidator.<{0}>";
	...
	{
		return ServiceAccessValidator.class.getName();
	}

	@Override
	protected String[] getNameComponentsFromAnnotationMetadata(AnnotationMetadata annotation)
	{
		ServiceAccessValidatorBeanMetadataLookupContainer container = new ServiceAccessValidatorBeanMetadataLookupContainer(annotation);
	...
	{
		ServiceAccessValidatorBeanMetadataLookupContainer metadata = (ServiceAccessValidatorBeanMetadataLookupContainer) container;
