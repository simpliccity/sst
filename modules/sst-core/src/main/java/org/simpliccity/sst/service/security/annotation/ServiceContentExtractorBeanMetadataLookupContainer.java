...
/**
 * A wrapper class encapsulating the metadata values used to lookup a {@link ServiceContentExtractor} component
 ...
 *
 */
public class ServiceContentExtractorBeanMetadataLookupContainer extends AbstractSimpleAnnotationBeanMetadataLookupContainer<ServiceContentExtractor> 
{
	 ...
	 */
	public ServiceContentExtractorBeanMetadataLookupContainer()
	{
		super(ServiceContentExtractor.class);
	}
	 ...
	 */
	public ServiceContentExtractorBeanMetadataLookupContainer(ServiceContentExtractor extractor)
	{
		super(ServiceContentExtractor.class);

		setValue(extractor.value());
	}
	 ...
	 */
	public ServiceContentExtractorBeanMetadataLookupContainer(AnnotationMetadata annotation)
	{
		super(ServiceContentExtractor.class);
		
		// Get the metadata for the Transformation annotation, using class names rather than classes
		Map<String, Object> attributes = annotation.getAnnotationAttributes(ServiceContentExtractor.class.getName(), true);
